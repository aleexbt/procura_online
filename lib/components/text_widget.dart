...
class TextWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
        padding: padding != null ? padding : EdgeInsets.only(left: 0, right: 0, top: 0, bottom: 0),
        child: Text(
          text == null ? 'N/A' : text,
...
enum TextType { TEXT_SMALL, TEXT_MEDIUM, TEXT_LARGE, TEXT_XLARGE, TEXT_XSMALL, TEXT_NORMAL }
